...
module.exports = "<div *ngIf=\"decade && years\">\n    <a class=\"last-decade-button\" [routerLink]=\"['/games/by/decade', decade-10]\">\n      <i class=\"fa fa-play fa-rotate-180\"></i>\n    </a>\n    <nav class=\"navbar\"> \n      <ul class=\"nav navbar-nav navbar-center profile-nav\">  \n        <li id=\"decade\">\n          <a class=\"selected\" [routerLink]=\"['/games/by/decade', decade]\">{{ decade }}s</a>\n        </li>\n        <li class=\"year\" *ngFor=\"let year of years\">\n          <a [routerLink]=\"['/games/by/decade', decade, 'by', 'year', year]\">{{ year }}</a>\n        </li>\n      </ul>\n    </nav>\n    <a class=\"next-decade-button\" [routerLink]=\"['/games/by/decade', decade+10]\">\n      <i class=\"fa fa-play\"></i>  \n    </a>\n  </div>"
...
// module
exports.push([module.i, "@media (max-width: 768px) { \n\t.attrib-rating {\n\t\tdisplay: block;\n\t}\n}\n\n@media (min-width: 769px) {\n\t.attrib-rating {\n\t\tdisplay: inline-block;\n\t}\n}\n\napp-star-rating {\n\tdisplay: inline-block; font-size: 8px; vertical-align: middle;\n}\n\n.thumb {\n\theight: 118px;\n\t/* width: 90px; */\n\twidth: 100%;\n\tmax-width: 90px;\n\tborder-radius: 4px;\n}\n\n.attrib-rating > span {\n    display: inline-block;\n}\n\n.attrib-rating > span {\n\tmargin-left: 5px;\n}\n\n.rating i {\n\tfloat: left;\n}\n\n.rating {\n\tvertical-align: middle;\n}\n\n.attribution img {\n\theight: 25px;\n\tmargin-right: 5px;\n}\n\n.attribution.comment-data {\n\tvertical-align: middle;\n}\n\n.user {\n\tvertical-align: middle;\n}\n\ni {\n\tcolor: gray;\n}\n\n.toggled {\n\tcolor: black;\n}\n\na {\n\tcolor: black;\n}\n\na:hover {\n\ttext-decoration: none;\n}\n\nh1\t{\n\tmargin-top: 0;\n}", ""]);
...
// module
exports.push([module.i, "@media (max-width: 768px) { \n\t.user-feature {\n        height: 150px;\n        width: 150px;\n    }\n}\n\n@media (min-width: 769px) {\n\t.user-feature {\n        height: 200px;\n        width: 200px;\n    }\n}\n\n.game-review, .user-list-item {\n    height: 50px;\n    width: 50px;\n}\n\n.review, .long-list, .list {\n    height: 25px;\n    width: 25px;\n}\n\n.review-detail {\n    height: 30px;\n    width: 30px;\n}\n\n.user-info {\n    height: 150px;\n    width: 150px;\n}\n\n", ""]);
...
module.exports = "<img *ngIf=\"avatar\" src=\"{{ avatar }}\" alt=\"\" class=\"img-circle\" [ngClass]=\"[type]\" >\n<i *ngIf=\"!avatar\" class=\"fa fa-user-circle\" [style.font-size]=\"height\"></i>\n"
...
module.exports = "<div class=\"row \">\n  <div class=\"col-md-2 col-xs-12\">\n    <!-- <img src=\"{{/assets/profile.png}}\" class=\"img-circle\" height=\"150px\"> -->\n    <app-avatar [avatar]=\"user?.avatar\" [type]=\"'user-info'\"></app-avatar>\n  </div>\n  <div class=\"col-md-4 col-xs-12\" style=\"padding: 20px\">\n    <h3>{{ user?.name }}</h3>\n    <button class=\"btn btn-primary\" *ngIf=\"authService?.user?.username === user?.username\" routerLink='edit'>EDIT PROFILE</button>\n  </div>\n  <div class=\"col-md-5 col-md-offset-1 col-xs-12 pull-right user-stats\">\n    <div class=\"user-info\">\n      <h4>{{ user?.playedCount }}</h4>\n      <p>Games</p>\n    </div>\n    <div class=\"user-info\">\n      <h4>{{ user?.playedCount }}</h4>\n      <p>This Year</p>\n    </div>\n    <div class=\"user-info\">\n      <h4>{{ user?.lists.length }}</h4>\n      <p>Lists</p>\n    </div>\n    <div class=\"user-info\">\n      <h4>0</h4>\n      <p>Following</p>\n    </div>\n    <div class=\"user-info\">\n      <h4>0</h4>\n      <p>Followers</p>\n    </div>\n  </div>\n</div>\n"
...
// module
exports.push([module.i, "@media (max-width: 768px) {\n    .pull-right > i {\n        display: none;\n    }\n}\n\n.fa {\n    margin-left: 75px; font-size: 2em; vertical-align: super\n}\n\n.fa > span {\n    font-size: 12px; vertical-align: middle; margin-left: 5px\n}\n\n.fa > span > a {\n    color: black;\n}", ""]);
